...
const AstrologicalCompatibilityAnalysis = () => {
  return (
    <div>
        ...
        <div className="card">
          <div className="row g-0">
            <div className="col-md-3">
              <Image src="/Astrological Compatibility Analysis.jpeg" alt="Astrological Compatibility Analysis" width={300} height={400} className="card-img" />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Astrological Compatibility Analysis</h5>
...
export default AstrologicalCompatibilityAnalysis;
