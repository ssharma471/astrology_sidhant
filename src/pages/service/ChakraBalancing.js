        ...
        <div className="card">
          <div className="row g-0">
            <div className="col-md-4">
              <Image src="/Chakra Balancing.jpeg" alt="Chakra Balancing" width={300} height={400} />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Chakra Balancing </h5>
                <p className="card-text">Description about Chakra Balancing goes here.</p>
