        ...
        <div className="card">
          <div className="row g-0">
            <div className="col-md-4">
              <Image src="/Dream Interpretation.png" alt="Dream Interpretation.png" width={300} height={400} />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Dream Interpretation </h5>
                <p className="card-text">Description about Dream Interpretation goes here.</p>
