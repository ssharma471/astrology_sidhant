        ...
        <div className="card">
          <div className="row g-0">
            <div className="col-md-4">
              <Image src="/Horoscope Predictions.jpg" alt="Horoscope Predictions.jpg" width={300} height={400} />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Horoscope Predictions </h5>
                <p className="card-text">Description about Horoscope Predictions goes here.</p>
