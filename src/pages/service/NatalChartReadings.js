...
<div>
  <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div className="card">
          <div className="row g-0">
            <div className="col-md-4">
              <Image src="/Natal Chart Readings.jpeg" alt="Natal Chart Readings.jpeg" width={300} height={400} />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Natal Chart Readings </h5>
                <p className="card-text">Description about Natal Chart Readings goes here.</p>
    ...
    </div>      {/* Add additional content here if needed */}
    </div>
  );
};

export default NatalChartReadings;
