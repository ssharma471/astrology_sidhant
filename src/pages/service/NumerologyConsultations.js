        ...
        <div className="card">
          <div className="row g-0">
            <div className="col-md-4">
              <Image src="/Numerology Consultations.png" alt="Numerology Consultations.png" width={300} height={400} />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Numerology Consultations </h5>
                <p className="card-text">Description about Numerology Consultations goes here.</p>
...
export default NumerologyConsultations
