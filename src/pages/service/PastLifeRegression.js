        ...
        <div className="card">
          <div className="row g-0">
            <div className="col-md-4">
              <Image src="/Past Life Regression.jpeg" alt="Past Life Regression.jpeg" width={300} height={400} />
            </div>
            <div className="col-md-8">
              <div className="card-body">
                <h5 className="card-title">Past Life Regression </h5>
                <p className="card-text">Description about Past Life Regression goes here.</p>
